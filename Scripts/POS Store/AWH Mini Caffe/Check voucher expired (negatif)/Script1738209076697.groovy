...
for (String voucher : voucherCodes) {
    try {
        ...
        if (WebUI.verifyTextPresent('Mohon Maaf Voucher Tidak dapat digunakan', false, FailureHandling.CONTINUE_ON_FAILURE)) {
			...
			WebUI.comment('✅ Voucher ' + voucher + ' sudah berhasil di identifikasi sebagai voucher expired')
            println('✅ Voucher ' + voucher + ' sudah berhasil di identifikasi sebagai voucher expired')

        } else if (WebUI.verifyTextPresent('Voucher applied successfully.', false, FailureHandling.CONTINUE_ON_FAILURE)) {
			...
			WebUI.comment('❎ Voucher ' + voucher + ' gagal di identifikasi , voucher ini masih bisa di gunakan dengan total diskon : '+ discountText)
            println('❎ Voucher ' + voucher + ' gagal di identifikasi , voucher ini masih bisa di gunakan dengan total diskon : '+ discountText)
