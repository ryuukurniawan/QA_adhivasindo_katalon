...
WebUI.click(findTestObject('Object Repository/Undangan by AWH/Client Area Undangan/Edit Buku Tamu Undangan Pernikahan/Tombol Hapus Data Tamu'))

WebUI.click(findTestObject('Object Repository/Undangan by AWH/Client Area Undangan/Edit Buku Tamu Undangan Pernikahan/Tombol Konfirmasi Hapus'))


WebUI.waitForAlert(4)
if (WebUI.verifyTextPresent(namaTamu,false,FailureHandling.OPTIONAL)) {
	println("✅ Delete data tamu gagal!")
}
else {
	println("❎ Delete data tamu berhasil")
}
