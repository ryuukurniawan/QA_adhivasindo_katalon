...
WebUI.scrollToElement(findTestObject('Object Repository/Project by AWH/Dusun Bambu Vendor/Dusum Bambu Trail Run/Prod/Tombol Daftar Family Run'),0)

WebUI.click(findTestObject('Object Repository/Project by AWH/Dusun Bambu Vendor/Dusum Bambu Trail Run/Prod/Tombol Daftar Family Run'))

WebUI.click(findTestObject('Object Repository/Project by AWH/Dusun Bambu Vendor/Dusum Bambu Trail Run/Prod/Tombol pilih partisipan Ayah, Ibu, Anak'))
...
if (WebUI.verifyTextPresent('Rp 275.000,-', false, FailureHandling.CONTINUE_ON_FAILURE)) {
	println('Teks Rp 275.000,- ditemukan')
